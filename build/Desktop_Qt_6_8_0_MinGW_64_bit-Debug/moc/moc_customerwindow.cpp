...
struct qt_meta_stringdata_CLASSCustomerWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCustomerWindowENDCLASS = QtMocHelpers::stringData(
    "CustomerWindow",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCustomerWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CustomerWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCustomerWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCustomerWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCustomerWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CustomerWindow, std::true_type>,
...
void CustomerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_btnLoadOrders_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *CustomerWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCustomerWindowENDCLASS.stringdata0))
